...
2. **Generate:** Run `make generate` to create Go code from SQL and templates
...
- Always run `make generate` after modifying `.templ` files, SQL migrations, or SQL queries
